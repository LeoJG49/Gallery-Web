document.addEventListener("DOMContentLoaded", () => {
    ...
    sidebarButtons.forEach(btn => {
        btn.addEventListener("click", () => {
            ...
            // Remove active from all buttons (both sidebar and mobile menu)
            ...
            const mobileBtn = document.querySelector(`.mobile-menu-item#${btn.id}, .mobile-storage-item#${btn.id}`);
            if (mobileBtn) {
